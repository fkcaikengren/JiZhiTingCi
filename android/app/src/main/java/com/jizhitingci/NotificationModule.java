...
public class NotificationModule extends ReactContextBaseJavaModule {
    ...
    //常量
    private static final String PALYER_TAG = "com.jizhitingci";
    private static final String CHANNEL_NAME = "com.jizhitingci";//渠道名字
    private static final String CHANNEL_ID = "com.jizhitingci"; // 渠道ID
    ...
    @SuppressLint("RestrictedApi")
    @ReactMethod
    public void updateWord(String word, Callback errorCallback) {
        try{
